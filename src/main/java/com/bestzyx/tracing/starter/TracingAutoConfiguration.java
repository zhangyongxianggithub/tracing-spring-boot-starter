...
public class TracingAutoConfiguration {
    ...
    // // tracingThreadPoolTaskExecutorCustomizer(
    // // final TracingProperties tracingProperties,
    ...
    @ConditionalOnProperty(prefix = "gbi.tracing",
            name = "enable-thread-tracing", matchIfMissing = true)
    public static TracingThreadPoolBeanPostProcessor tracingThreadPoolBeanPostProcessor(
            final TracingProperties tracingProperties) {
        return new TracingThreadPoolBeanPostProcessor(tracingProperties);
    }
